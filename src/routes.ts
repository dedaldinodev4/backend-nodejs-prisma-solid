...
//* Validators Entities *//
import { validatorProduct, validatorCategory, validatorProductCategory } from "./models/Validate";


const router = Router();

//* Products Routes *//
router.post(`${__BASE_URL}/products`, 
    validatorProduct,
    (request, response) => {
...
router.put(`${__BASE_URL}/products/:id`, 
    validatorProduct,
    (request, response) => {
...
router.post(`${__BASE_URL}/productWithCategories/:id`, 
    (request, response) => {
...
//* Categories Routes  *//
router.post(`${__BASE_URL}/categories`, 
    validatorCategory,
    (request, response) => {
...
router.put(`${__BASE_URL}/categories/:id`, 
    validatorCategory,
    (request, response) => {
...
router.post(`${__BASE_URL}/productCategories`, 
    validatorProductCategory,
    (request, response) => {
